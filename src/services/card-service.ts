...
export const cardService = {
  getUserCards: async (): Promise<ApiResponse<Card[]>> => {
    try {
      ...
      // For development, return mock data with explicit last4 property
      if (import.meta.env.DEV) {
        console.log("DEV MODE: Returning mock card data with last4")
        return {
          success: true,
          message: "Cards retrieved successfully (mock)",
          data: [
            {
              id: "card_1",
              type: "visa",
